...
|------------- | ------------- | -------------|
| [**getAll**](BeneficiariesApi.md#getAll) | **GET** /accounts/{AccountId}/beneficiaries | Get Beneficiaries |
| [**getAll_0**](BeneficiariesApi.md#getAll_0) | **GET** /beneficiaries | Get Beneficiaries |


<a name="getAll"></a>
# **getAll**
> OBReadBeneficiary5 getAll(accountId).xFapiAuthDate(xFapiAuthDate).xFapiCustomerIpAddress(xFapiCustomerIpAddress).xFapiInteractionId(xFapiInteractionId).xCustomerUserAgent(xCustomerUserAgent).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling BeneficiariesApi#getAll");
...
<a name="getAll_0"></a>
# **getAll_0**
> OBReadBeneficiary5 getAll_0().xFapiAuthDate(xFapiAuthDate).xFapiCustomerIpAddress(xFapiCustomerIpAddress).xFapiInteractionId(xFapiInteractionId).xCustomerUserAgent(xCustomerUserAgent).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling BeneficiariesApi#getAll_0");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
