...
public class DirectDebitsApiGenerated {
    ...
    private ApiResponse<OBReadDirectDebit2> getAllWithHttpInfo(String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
    ...
    private okhttp3.Call getAllAsync(String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadDirectDebit2> _callback) throws ApiException {
    ...
    public class GetAllRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> Direct Debits Read </td><td>  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id. <br>  </td></tr>
        ...
        public OBReadDirectDebit2 execute() throws ApiException {
            ApiResponse<OBReadDirectDebit2> localVarResp = getAllWithHttpInfo(xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
    ...
    private okhttp3.Call listCall(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountId' is set
        if (accountId == null) {
            throw new ApiException("Missing the required parameter 'accountId' when calling list(Async)");
        }

        return listCall(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);

    }


    private ApiResponse<OBReadDirectDebit2> listWithHttpInfo(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, null);
        Type localVarReturnType = new TypeToken<OBReadDirectDebit2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(String accountId, String xFapiAuthDate, String xFapiCustomerIpAddress, String xFapiInteractionId, String xCustomerUserAgent, final ApiCallback<OBReadDirectDebit2> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        Type localVarReturnType = new TypeToken<OBReadDirectDebit2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
        ...
        private ListRequestBuilder(String accountId) {
         ...
         */
        public OBReadDirectDebit2 execute() throws ApiException {
            ApiResponse<OBReadDirectDebit2> localVarResp = listWithHttpInfo(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<OBReadDirectDebit2> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OBReadDirectDebit2> _callback) throws ApiException {
            return listAsync(accountId, xFapiAuthDate, xFapiCustomerIpAddress, xFapiInteractionId, xCustomerUserAgent, _callback);
        }
    }
     ...
     */
    public ListRequestBuilder list(String accountId) throws IllegalArgumentException {
        if (accountId == null) throw new IllegalArgumentException("\"accountId\" is required but got null");
            

        return new ListRequestBuilder(accountId);
    }
}
