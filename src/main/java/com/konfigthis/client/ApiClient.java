...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://openbanking.org.uk";
    private String tokenUrl = "https://authserver.example/token";
    ...
    private void init() {
        ...
        setUserAgent("Konfig/3.1.7/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://openbanking.org.uk)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://authserver.example/token)
     * @return An instance of OkHttpClient
     */
