...
public class OBAccount6Detail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, accountId, accountSubType, accountType, currency, description, maturityDate, nickname, openingDate, servicer, status, statusUpdateDateTime, switchStatus, additionalProperties);
  }
