...
public class OBAccount4 {
  ...
  **/
   ...
   * @return the OBAccount4 instance itself
   */
  public OBAccount4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, obAccount4.account) &&
        ...
        Objects.equals(this.additionalProperties, obAccount4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBAccount4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBAccount4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBAccount4 is not found in the empty JSON string", OBAccount4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBAccount4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBAccount4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBAccount4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBAccount4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBAccount4.class));

       return (TypeAdapter<T>) new TypeAdapter<OBAccount4>() {
           @Override
           public void write(JsonWriter out, OBAccount4 value) throws IOException {
           ...
           @Override
           public OBAccount4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBAccount4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBAccount4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBAccount4
  * @throws IOException if the JSON string is invalid with respect to OBAccount4
  */
  public static OBAccount4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBAccount4.class);
  }

 /**
  * Convert an instance of OBAccount4 to an JSON string
  *
  * @return JSON string
  */
