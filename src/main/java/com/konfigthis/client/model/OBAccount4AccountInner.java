...
public class OBAccount4AccountInner {
  ...
  **/
   ...
   * @return the OBAccount4AccountInner instance itself
   */
  public OBAccount4AccountInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identification, obAccount4AccountInner.identification) &&
        Objects.equals(this.name, obAccount4AccountInner.name) &&
        Objects.equals(this.schemeName, obAccount4AccountInner.schemeName) &&
        Objects.equals(this.secondaryIdentification, obAccount4AccountInner.secondaryIdentification)&&
        Objects.equals(this.additionalProperties, obAccount4AccountInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OBAccount4AccountInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OBAccount4AccountInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OBAccount4AccountInner is not found in the empty JSON string", OBAccount4AccountInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OBAccount4AccountInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OBAccount4AccountInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OBAccount4AccountInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OBAccount4AccountInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OBAccount4AccountInner.class));

       return (TypeAdapter<T>) new TypeAdapter<OBAccount4AccountInner>() {
           @Override
           public void write(JsonWriter out, OBAccount4AccountInner value) throws IOException {
           ...
           @Override
           public OBAccount4AccountInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OBAccount4AccountInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OBAccount4AccountInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OBAccount4AccountInner
  * @throws IOException if the JSON string is invalid with respect to OBAccount4AccountInner
  */
  public static OBAccount4AccountInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OBAccount4AccountInner.class);
  }

 /**
  * Convert an instance of OBAccount4AccountInner to an JSON string
  *
  * @return JSON string
  */
